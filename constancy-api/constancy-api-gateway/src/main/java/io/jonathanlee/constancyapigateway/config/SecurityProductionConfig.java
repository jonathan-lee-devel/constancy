package io.jonathanlee.constancyapigateway.config;
...
public class SecurityProductionConfig {
  ...
  protected ServerLogoutSuccessHandler logoutSuccessHandler() {
    ...
    logoutSuccessHandler.setPostLogoutRedirectUri(String.format("%s/keycloak-logout-success", gatewayUrl));
  ...
  SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
    http
        ...
        .authorizeExchange(authorizeExchangeSpec -> {
          authorizeExchangeSpec.pathMatchers("/logout").permitAll();
